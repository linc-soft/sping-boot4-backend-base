 ...
 * — only authentication. Other endpoints support listing, viewing, and updating resources.
 *
 * @author 林创科技
 * @since 2026-06-17
 */
...
public class ResourceController {
  ...
  @GetMapping
  @PreAuthorize("hasRole(T(com.lincsoft.constant.RoleCodeEnums).LIST_RESOURCE.roleCode)")
  public List<ResourceTreeNode> getResourceTree() {
    return resourceService.getResourceTree();
  }

  @GetMapping("/{id}")
  @PreAuthorize("hasRole(T(com.lincsoft.constant.RoleCodeEnums).VIEW_RESOURCE.roleCode)")
  public SysResource getResource(@PathVariable Long id) {
    return resourceService.getResourceById(id);
  }

  @PutMapping
  @PreAuthorize("hasRole(T(com.lincsoft.constant.RoleCodeEnums).UPDATE_RESOURCE.roleCode)")
