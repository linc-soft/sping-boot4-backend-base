...
(
  ...
  update_at DATETIME     DEFAULT CURRENT_TIMESTAMP COMMENT 'updated time',
...
(
  ...
  parent_role_id BIGINT       DEFAULT NULL COMMENT 'Parent role ID (NULL = root)',
  ...
  deleted        TINYINT(1)   DEFAULT 0 COMMENT 'Logical delete flag',
  PRIMARY KEY (id),
  INDEX idx_role_parent_role_id (parent_role_id)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
...
-- departments.
-- ============================================================
DROP TABLE IF EXISTS mst_user_dept;
...
-- ============================================================
DROP TABLE IF EXISTS mst_role_data_scope;
...
-- perm_bits:    bitmask READ=1, WRITE=2, DELETE=4, EXPORT=8
-- ============================================================
DROP TABLE IF EXISTS mst_data_permission_grant;
...
INSERT INTO mst_role_data_scope (role_id, scope_type, dept_id, perm_bits, enabled, inheritable, create_by, update_by)
VALUES (1, 'ALL', NULL, 15, 1, 0, 'system', 'system');

INSERT INTO mst_dept (dept_name, parent_id, sort_order, status, create_by, update_by)
VALUES ('Root Department', NULL, 0, '1', 'system', 'system');

INSERT INTO mst_user_dept (user_id, dept_id, create_by, update_by)
VALUES (1, 1, 'system', 'system');
