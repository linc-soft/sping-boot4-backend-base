...
(
  ...
  start_date          DATE         DEFAULT NULL COMMENT 'Leave start date',
  start_period        VARCHAR(2)   DEFAULT NULL COMMENT 'Period: 0=AM 1=PM',
  end_date            DATE         DEFAULT NULL COMMENT 'Leave end date',
  end_period          VARCHAR(2)   DEFAULT NULL COMMENT 'Period: 0=AM 1=PM',
