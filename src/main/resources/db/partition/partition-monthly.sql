...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Access log (monthly partition)'
  PARTITION BY
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Error log (monthly partition)'
  PARTITION BY
    RANGE (TO_DAYS(create_time)) (
    PARTITION p_init
      VALUES
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Operation log (monthly partition)'
  PARTITION BY
    RANGE (TO_DAYS(create_time)) (
    PARTITION p_init
      VALUES
