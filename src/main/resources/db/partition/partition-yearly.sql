...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Access log (yearly partition)'
  PARTITION BY
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Error log (yearly partition)'
  PARTITION BY
    RANGE (YEAR(create_time)) (
    PARTITION p_init
      VALUES
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Operation log (yearly partition)'
  PARTITION BY
    RANGE (YEAR(create_time)) (
    PARTITION p_init
      VALUES
